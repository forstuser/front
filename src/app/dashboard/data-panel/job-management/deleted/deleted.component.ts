...
export class DeletedComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.userType === 1 || this.userType === 2) {
      this.userservice.getAdminJobList(3,this.offset) // new = 4 refer api doc
        .subscribe(bill => {
          this.billList = bill;
    ...
    // if userType is CE get list of new bills
      ...
      this.userservice.getCEJobList(3,this.userId,this.offset) // new = 4 refer api doc
        .subscribe(bill => {
          this.billList = bill;
          console.log(this.billList);
        });
    ...
    // if userType is QE get list of new bills
      ...
      this.userservice.getQEJobList(3, this.userId,this.offset) // new = 4 refer api doc
        .subscribe(bill => {
          this.billList = bill;
          console.log(this.billList);
        });
  ...
  left() {
    ...
    if (this.userType === 1 || this.userType === 2) {
      this.userservice.getAdminJobList(3, this.offset)
        .subscribe(bills => {
          console.log(bills)
          this.billList = bills;
          console.log(this.billList);
      ...
      this.userservice.getCEJobList(3, this.userId, this.offset) // 4 for qe refer to api doc
        .subscribe(bills => {
          this.billList = bills;
          console.log(bills);
        });
