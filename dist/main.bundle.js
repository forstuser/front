...
var UserService = (function () {
    ...
    UserService.prototype.createProduct = function (prod) {
        ...
        delete prod['billId'];
        Object.keys(prod).forEach(function (key) { return (prod[key] == '' || prod[key] == null) && !(prod[key] instanceof Array) && delete prod[key]; });
...
var CreateBillComponent = (function () {
    ...
    // remove image
    CreateBillComponent.prototype.removeImage = function (i, $event) {
